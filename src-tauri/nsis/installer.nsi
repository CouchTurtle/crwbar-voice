; Custom NSIS template for crwbar voice with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch the default directory to the desktop
...
Function .onInit
  ...
  ; or a legacy Handy/empty marker. Require Data/
  ...
  ${AndIf} ${FileExists} "$INSTDIR\portable"
    ...
    FileRead $1 $2
    FileClose $1
    ${If} $2 == "crwbar voice Portable Mode"
      StrCpy $PortableMode 1
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "crwbar voice Portable Mode"
    FileClose $0
